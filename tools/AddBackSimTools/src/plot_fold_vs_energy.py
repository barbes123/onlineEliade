...
#else:
#    print(f"No CloverID provided, default {clover}")
...
# Format plot
plt.xlabel(r'$E\gamma$, keV', fontsize=12)
plt.ylabel('fraction of the total events', fontsize=12)
plt.title(f'Normalized Area Clover {clover}', fontsize=14)
...
plt.savefig(
    f'../figures_src/normalized_areas.png',
    dpi=300,
    bbox_inches='tight',
    transparent=False
)
...
plt.savefig(
    f'../figures_src/normalized_areas_with_errors_Clover{clover}.png',
    dpi=300,
    bbox_inches='tight',
    transparent=False
)
...
#plt.title(f'Normalized Area vs Energy by Fold Clover{clover} ', fontsize=14)
...
# Save and show plot
plt.savefig(f'../figures_src/normalized_areas_Clover{clover}.png', dpi=300)
plt.savefig(f'../figures_src/normalized_areas.png', dpi=300)
plt.show()
