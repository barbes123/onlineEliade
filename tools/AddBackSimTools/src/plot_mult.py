...
#list_of_lut_2024 = {"S1":"CL33", "S2":"CL30", "S6":"CL31", "S3":"CL32", "S7":"CL29", "S5":"CL34", "S4":"CL35", "S8":"CL36"}
#list_of_runs = {'60Co':58, '152Eu':57, '133Ba':56}
#server = 3
volume = 999
files = []
...
for isotope, run in list_of_runs.items():
    ...
    file = f'../addback_run_{run}_{volume}_eliadeS{server}/px_mult.spe'
...
plt.savefig(f'../figures_src/fold_spectra_S{server}.jpg', dpi = 300)
plt.savefig(f'../figures_src/fold_spectra.jpg', dpi = 300)
