...
#  awk -F " " '{ print $1 " " $5 " " $9 " " $6 " " $7 " " $7/$6*$9 " [keV]; eff [%]: " $5/'$activityEu152'*100}' 152Eu.temp > temp1.txt
#  grep '121.779' temp1.txt >> resolution_121.txt
#  grep '244.693' temp1.txt >> resolution_244.txt
#  grep '344.272' temp1.txt >> resolution_344.txt
#  grep '411.111' temp1.txt >> resolution_411.txt
#  grep '443.979' temp1.txt >> resolution_444.txt
#  grep '778.890' temp1.txt >> resolution_778.txt
#  grep '964.014' temp1.txt >> resolution_964.txt
#  grep '1085.793' temp1.txt >> resolution_1085.txt
#  grep '1112.070' temp1.txt >> resolution_1112.txt
...
#  grep '121.779' temp1.txt > resolutionEu152.txt
#  grep '244.693' temp1.txt >> resolutionEu152.txt
#  grep '344.272' temp1.txt >> resolutionEu152.txt
#  grep '411.111' temp1.txt >> resolutionEu152.txt
#  grep '443.979' temp1.txt >> resolutionEu152.txt
#  grep '778.890' temp1.txt >> resolutionEu152.txt
#  grep '964.014' temp1.txt >> resolutionEu152.txt
#  grep '1085.793' temp1.txt >> resolutionEu152.txt
#  grep '1112.070' temp1.txt >> resolutionEu152.txt
#  grep '1407.993' temp1.txt >> resolutionEu152.txt
  
  gnuplot -e "ENER=121" res_eliade_ener.p
  gnuplot -e "ENER=244" res_eliade_ener.p
  gnuplot -e "ENER=344" res_eliade_ener.p
  gnuplot -e "ENER=411" res_eliade_ener.p
  gnuplot -e "ENER=444" res_eliade_ener.p
  gnuplot -e "ENER=778" res_eliade_ener.p
  gnuplot -e "ENER=964" res_eliade_ener.p
  gnuplot -e "ENER=1085" res_eliade_ener.p
  gnuplot -e "ENER=1112" res_eliade_ener.p
  gnuplot -e "ENER=1408" res_eliade_ener.p
