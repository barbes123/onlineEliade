...
do
	...
	volume1=0
	volnb=$volume1
	fileout="sum_$prefix""_$runnb""_$volume1""_$volume1""_$suffix"."root"
	command="hadd sum_$prefix""_run$runnb""_$volume1""_$volume1""_$suffix"."root "
	...
	while test $flag -eq 1
	 do 
	 current_file="$prefix""_$runnb""_$volnb""_$suffix"".root"
