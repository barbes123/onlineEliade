...
# try:
#     lut_path = os.getenv('ELIADE_LUT')
# except:
#     print('Cannont find environmental ELIADE_LUT variable, please, check')
#     sys.exit()
...
def do_calibration(dir):
    ...
    cmd = ['pc', '-d', '111', '115']  # Define the command list first
...
def main():
    ...
    parser.add_argument("-lut" "--LUT_ELIADE.json",
                        dest="lut", default='LUT_LABR_S7_20250611.json', type=str,
